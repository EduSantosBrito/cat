...
<body id="page-top">
    ...
    <section id="submission">
        <div class="container">
            ...
            <p class="card-text">Observe que o Título, o Resumo, as Palavras-chave, abstract, key-words e as Informações dos autores (nome completo, maior titulação e instituição) serão fornecidas durante a submissão do artigo, na página de submissão do CAT, de forma que o arquivo enviado deve iniciar pela Introdução. Recapitulando, o arquivo que será anexado em seu navegador e submetido para o evento <span class="text-danger">NÃO</span> poderá ter Título, Resumo, Palavras-chave e Informações dos autores, pois essas informações serão cadastradas na página de submissão do CAT. Para não haver divergências daquilo que o evento solicita com o que será submetido, basta seguir o modelo, que se inicia pela seção Introdução.</p>

            <p><span class="text-danger">ATENÇÃO:</span> Os artigos deverão ser submetidos em formato <span class="text-muted">DOC ou DOCX</span>, SEM ESTAR PROTEGIDO, ou seja, livre para edição. Vale ressaltar que não deve haver qualquer identificação dos autores e suas respectivas instituições no texto do artigo enviado. A identificação do artigo pelo autor ocorrerá automaticamente, por meio das informações digitadas no ato de submissão do artigo na página do CAT. A submissão será por meio do formulário abaixo, a partir do dia 15 de Maio de 2017 até 01 de Setembro de 2017. A partir desta data, o arquivo será encaminhado à Comissão Científica, bloqueando a edição ou alterações no artigo. Quando o trabalho for aprovado para apresentação em pôster, o mesmo deverá possuir o tamanho 0,9 m (largura) X 1,2 m (altura) e preparado sem emendas. A formatação e a organização do conteúdo do pôster devem seguir o modelo sugerido para o evento. Os autores dos artigos aprovados para apresentação como pôster receberão por e-mail o modelo a ser seguido. A Comissão Científica é a responsável pela avaliação e seleção dos artigos, classificando-os nas opções "apresentação oral” ou "pôster". Serão considerados os aspectos relativos à originalidade, relevância do tema, embasamento teórico, qualidade técnica e apresentação.</p>
